  ...
  return (
    <main className="agency-landing min-h-screen bg-white px-4 py-14 text-zinc-700 sm:px-6 lg:px-10">
      <div className="mx-auto max-w-2xl">
        <Link href="/" className="text-sm font-medium text-[#1860F0] hover:underline">
          ← Back to home
        </Link>
        <h1 className="mt-8 text-2xl font-bold tracking-tight text-[#182635] sm:text-3xl">Terms of use</h1>
        ...
        <h2 className="mt-10 text-sm font-bold uppercase tracking-wide text-[#182635]">Use of the site</h2>
        ...
        <h2 className="mt-8 text-sm font-bold uppercase tracking-wide text-[#182635]">Proposals & payments</h2>
        <p className="mt-3 text-sm leading-relaxed text-zinc-600">
        ...
        <h2 className="mt-8 text-sm font-bold uppercase tracking-wide text-[#182635]">Intellectual property</h2>
        <p className="mt-3 text-sm leading-relaxed text-zinc-600">
        ...
        <h2 className="mt-8 text-sm font-bold uppercase tracking-wide text-[#182635]">Limitation of liability</h2>
        <p className="mt-3 text-sm leading-relaxed text-zinc-600">

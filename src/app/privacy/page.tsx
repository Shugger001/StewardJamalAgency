  ...
  return (
    <main className="agency-landing min-h-screen bg-white px-4 py-14 text-zinc-700 sm:px-6 lg:px-10">
      <div className="mx-auto max-w-2xl">
        ...
        <h1 className="mt-8 text-2xl font-bold tracking-tight text-[#182635] sm:text-3xl">Privacy policy</h1>
        ...
        <h2 className="mt-10 text-sm font-bold uppercase tracking-wide text-[#182635]">Information we collect</h2>
        ...
        <h2 className="mt-8 text-sm font-bold uppercase tracking-wide text-[#182635]">How we use information</h2>
        <p className="mt-3 text-sm leading-relaxed text-zinc-600">
        ...
        <h2 className="mt-8 text-sm font-bold uppercase tracking-wide text-[#182635]">Retention & sharing</h2>
        <p className="mt-3 text-sm leading-relaxed text-zinc-600">
        ...
        <h2 className="mt-8 text-sm font-bold uppercase tracking-wide text-[#182635]">Your choices</h2>
        <p className="mt-3 text-sm leading-relaxed text-zinc-600">

  ...
  return (
    <section style={{ backgroundColor: DB.sky }} className="border-b border-zinc-200">
      <div className={`${LANDING_GUTTER} py-12 lg:py-14`}>
        {eyebrow ? (
          <p className="text-xs font-semibold uppercase tracking-[0.14em] text-[#1860F0]">{eyebrow}</p>
        ) : null}
        <h1 className="mt-2 text-3xl font-bold text-[#182635] sm:text-4xl">{title}</h1>
        {description ? (
